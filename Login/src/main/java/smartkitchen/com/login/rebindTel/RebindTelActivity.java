...
public class RebindTelActivity extends AppCompatActivity {
    private String   oldMobileNum, newMobileNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oldMobileNum = getIntent().getStringExtra("oldMobileNum");

        if(TextUtils.isEmpty(newMobileNum)|TextUtils.isEmpty(oldMobileNum))
        {
    ...
    public void onClickChange(View v)
    {
        ...
        //验证数据正确性
        // Check for psw.
        if (TextUtils.isEmpty(psw1) | isPasswordInValid(psw1))
        {
        ...
        if (TextUtils.isEmpty(psw2) | isPasswordInValid(psw2))
        {
        ...
        } else
        {
            ...
            RequestBody requestBody = new FormBody.Builder()
                    .add("newMobile", newMobileNum)
                    .add("oldMobile",oldMobileNum)
                    .add("password", psw1)
                    .build();
            ...
            public void run()
            {
                ...
                if(flag)
                {
                    ...
                    if("ok".equals(obj.getStatus()))
                    {
                        ...
                        intent.putExtra("mobile",newMobileNum);
