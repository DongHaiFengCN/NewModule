package doaing.dishesmanager.view;
 ...
 * 类描述：
 * 创建人：donghaifeng
 * 创建时间：2018/1/18 16:35
 * 修改人：donghaifeng
 * 修改时间：2018/1/18 16:35
 * 修改备注：item滑动删除
 */

public class MySwipeListLayout extends FrameLayout {
    ...
    public MySwipeListLayout(Context context) {
        this(context, null);
    }

    public MySwipeListLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (releasedChild == itemView) {
                if (xvel == 0
                        && Math.abs(itemView.getLeft()) > hiddenViewWidth / 3.0f) {
                    open(smooth);
                } else if (xvel < 0) {
                    open(smooth);
                } else {
